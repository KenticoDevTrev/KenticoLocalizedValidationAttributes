...
namespace HBS.LocalizedValidationAttributes.Kentico.MVC
{
    ...
    /// </summary>
    public class LocalizedMinLengthAttribute : MinLengthAttribute, IClientValidatable
    {
        ...
        {
            yield return new ModelClientValidationMinLengthRule(FormatErrorMessage(metadata.GetDisplayName()), Length);
        }
    }
}